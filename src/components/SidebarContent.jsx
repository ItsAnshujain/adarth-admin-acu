    ...
    () => [
      ...
      },
      {
        ...
        nested: [
          ...
          { label: '1. Client company type', subPath: '/report2' },
          { label: '2. Operational Costs', subPath: '/operationalCostPage' },
          { label: '3. Sales Revenue', subPath: '/otherSalesPage' },
          { label: '4. Other Revenues', subPath: '/otherrevenues' },
