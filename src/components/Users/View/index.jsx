...
import { Tabs, Button, Image, Skeleton } from '@mantine/core';
  ...
  return (
    <Tabs value={activeTab} onTabChange={setActiveTab}>
      <Tabs.List className="h-[60px] relative">
        ...
        {/* TODO: remove disable update data later  */}
        <Tabs.Tab className="text-base hover:bg-transparent" value="second" disabled>
          Managing
        </Tabs.Tab>
      </Tabs.List>
