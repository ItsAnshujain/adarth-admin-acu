    ...
    <div>
      ...
      <div className="pl-5 pr-7 pt-4 pb-8 border-b">
        ...
        <div className="grid grid-cols-2 gap-4 pb-4">
          <TextInput styles={styles} label="Voucher No" placeholder="Write..." />
          <TextInput styles={styles} label="GST" placeholder="Write..." />
        </div>
      ...
      <div className="pl-5 pr-7 pt-4 border-b">
        ...
        <div className="grid grid-cols-2 gap-4 pb-4">
          <TextInput styles={styles} label="Dispatch Through" placeholder="Write..." />
